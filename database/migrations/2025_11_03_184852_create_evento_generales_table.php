...
return new class extends Migration
{
    ...
    {
        Schema::create('evento_generales', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('id_pago_cuotas')->foreign()->references('id')->on('pago_cuotas')->onDelete('cascade');
            $table->integer('id_tipo_pago'); // TODO: Verificar si existe una tabla o hay que crearla para mostrar nombre/descripcion
            $table->bigInteger('id_campana')->nullable()->foreign()->references('id')->on('campanas')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('evento_generales');
    }
};
